...
?>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <p>
            Regardless, I can say with some confidence that I am rather comfortable with
            relational databases, including MySQL. For years, I maintained a rather
            detailed MS Access database of my rather extensive DVD collection; among other
            things, this is what I would use to practice coding by mimicking in my own
            fashion some of the basic principles behind the Internet Movie Database.
        </p>
        <p>
            That is, until I could no longer afford Access and until I had to sell my
            DVD collection. :(
        </p>
        <p>
